...
@client.on(events.NewMessage(pattern='^(?i)/cancel@autotagger_bot'))
...
/cancel@autotaggee_bot - Etiket işlemini iptal ederim.
...
print(">> Bot çalışıyor merak etme 👮‍♂️ @tht_herlock bilgi alabilirsin <<")
